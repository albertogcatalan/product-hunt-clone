...
(1, '/', 'home', 1),
(2, '/404/', '404', 1),
(123, '/profile/([a-zA-Z0-9-_]+)?[/]?', 'profiles/profile', 1),
(5, '/logout/', 'logout', 1),
(125, '/admin/([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?', 'admin/main', 1),
(118, '/about/', 'pages/about', 1),
(119, '/project/([a-zA-Z0-9-_]+)/([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?([a-zA-Z0-9-_]+)?[/]?', 'projects/main', 1),
(120, '/language/([a-zA-Z]{3})/', 'language', 1),
(122, '/l/([a-zA-Z0-9-_]+)?[/]?', 'projects/link', 1),
(124, '/settings/', 'profiles/settings', 1);
